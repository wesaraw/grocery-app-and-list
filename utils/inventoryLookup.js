...
export async function createInventoryLookup(loaders = {}) {
  ...
  // Store selections are auto-populated for every catalog item, so we only
  // seed the canonical map from the core timeline tables plus any serialized
  // item names already tracked in the ID map.
