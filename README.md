...
The Android source under `android/` compiles with Gradle. The extension files are copied into:
...
You must generate your own keystore and store credentials outside version control.
