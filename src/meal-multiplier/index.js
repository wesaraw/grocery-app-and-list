...
import { calculateMealNeeds as plannerCalc } from '../meal-planner/index.js';

// Exposed hook to allow tests to stub the meal math call.
export const hooks = { calculateMealNeeds: plannerCalc };
...
export async function renderMultiplier(root) {
