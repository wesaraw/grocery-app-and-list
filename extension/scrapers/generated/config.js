import { registerStoreStrategy, selectOne, parsePriceNumber } from './common.js';
...
function extractWalmartPrice(tile) {
    ...
    if (!container)
        return { priceText: null, priceNumber: null };
...
export { amazon, hannaford, rocheBros, shaws, stopAndShop, walmart };
